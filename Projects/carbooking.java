    ...
    public static void main(String[] args) {
        ...
        Scanner n = new Scanner(System.in);
            ...
            while("Yes".equals(str) || "yes".equals(str) || "YES".equals(str))
            {
                ...
                if("2020 Maruti Suzuki DZire VXi AMT".equals(str1) || "1".equals(str)){
                ...
                else if("2016 Toyota Camry Hybrid".equals(str1) || "2013 Toyota Corolla Fz".equals(str1) || "3".equals(str1) || "4".equals(str1)){
                    System.out.println("Per day price is = ₹3,500 - ₹4,000");
                    }
                else if("2022 Hyundai Aura S 1.2 Petrol".equals(str1) || "5".equals(str1)){
                ...
                if("YES".equals(str2) || "yes".equals(str2) || "Yes".equals(str2) || "ya".equals(str2) ){
                    ...
                    if("Yes".equals(str3) || "yes".equals(str3))
                    {
                ...
                while("NO".equals(str2) || "no".equals(str2)){
                    System.out.println("Thanks for visiting my showroom");
                    break;
                }
                break;
